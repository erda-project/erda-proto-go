...
func (c *logQueryServiceClient) GetLog(ctx context.Context, in *GetLogRequest, opts ...grpc.CallOption) (*GetLogResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/erda.monitor.core.logs.query.LogQueryService/GetLog", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *logQueryServiceClient) GetLogByRuntime(ctx context.Context, in *GetLogByRuntimeRequest, opts ...grpc.CallOption) (*GetLogByRuntimeResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/erda.monitor.core.logs.query.LogQueryService/GetLogByRuntime", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *logQueryServiceClient) GetLogByOrganization(ctx context.Context, in *GetLogByOrganizationRequest, opts ...grpc.CallOption) (*GetLogByOrganizationResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/erda.monitor.core.logs.query.LogQueryService/GetLogByOrganization", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
var _LogQueryService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "erda.monitor.core.logs.query.LogQueryService",
...
func _get_LogQueryService_serviceDesc(srv LogQueryServiceServer, opts ...grpc1.HandleOption) *grpc.ServiceDesc {
	...
	if h.Interceptor != nil {
		_LogQueryService_GetLog_info = transport.NewServiceInfo("erda.monitor.core.logs.query.LogQueryService", "GetLog", srv)
	...
	if h.Interceptor != nil {
		_LogQueryService_GetLogByRuntime_info = transport.NewServiceInfo("erda.monitor.core.logs.query.LogQueryService", "GetLogByRuntime", srv)
	...
	if h.Interceptor != nil {
		_LogQueryService_GetLogByOrganization_info = transport.NewServiceInfo("erda.monitor.core.logs.query.LogQueryService", "GetLogByOrganization", srv)
	...
	serviceDesc.Methods = []grpc.MethodDesc{
		{
			...
			Handler: func(_ interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
				...
				info := &grpc.UnaryServerInfo{
					Server:     srv,
					FullMethod: "/erda.monitor.core.logs.query.LogQueryService/GetLog",
				}
		...
		},
		{
			...
			Handler: func(_ interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
				...
				info := &grpc.UnaryServerInfo{
					Server:     srv,
					FullMethod: "/erda.monitor.core.logs.query.LogQueryService/GetLogByRuntime",
				}
		...
		},
		{
			...
			Handler: func(_ interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
				...
				info := &grpc.UnaryServerInfo{
					Server:     srv,
					FullMethod: "/erda.monitor.core.logs.query.LogQueryService/GetLogByOrganization",
				}
