...
func (c *projectServiceClient) GetProjects(ctx context.Context, in *GetProjectsRequest, opts ...grpc.CallOption) (*GetProjectsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/erda.msp.apm.project.ProjectService/GetProjects", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
var _ProjectService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "erda.msp.apm.project.ProjectService",
...
func _get_ProjectService_serviceDesc(srv ProjectServiceServer, opts ...grpc1.HandleOption) *grpc.ServiceDesc {
	...
	if h.Interceptor != nil {
		_ProjectService_GetProjects_info = transport.NewServiceInfo("erda.msp.apm.project.ProjectService", "GetProjects", srv)
	...
	serviceDesc.Methods = []grpc.MethodDesc{
		{
			...
			Handler: func(_ interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
				...
				info := &grpc.UnaryServerInfo{
					Server:     srv,
					FullMethod: "/erda.msp.apm.project.ProjectService/GetProjects",
				}
