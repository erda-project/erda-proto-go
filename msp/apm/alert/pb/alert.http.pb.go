...
func RegisterAlertServiceHandler(r http.Router, srv AlertServiceHandler, opts ...http.HandleOption) {
	...
	add_QueryAlertRule("GET", "/api/apm/alerts/rules", srv.QueryAlertRule)
	add_QueryAlert("GET", "/api/apm/alerts", srv.QueryAlert)
	add_GetAlert("GET", "/api/apm/alert/{id}", srv.GetAlert)
	add_CreateAlert("POST", "/api/apm/alert", srv.CreateAlert)
	add_UpdateAlert("PUT", "/api/apm/alert/{id}", srv.UpdateAlert)
	add_UpdateAlertEnable("PUT", "/api/apm/alert/{id}/switch", srv.UpdateAlertEnable)
	add_DeleteAlert("DELETE", "/api/apm/alert/{id}", srv.DeleteAlert)
	add_QueryCustomizeMetric("GET", "/api/apm/customize/alerts/metrics", srv.QueryCustomizeMetric)
	add_QueryCustomizeNotifyTarget("GET", "/api/apm/customize/alerts/notifies/targets", srv.QueryCustomizeNotifyTarget)
	add_QueryCustomizeAlerts("GET", "/api/apm/customize/alerts", srv.QueryCustomizeAlerts)
	add_GetCustomizeAlert("GET", "/api/apm/customize/alert/{id}", srv.GetCustomizeAlert)
	add_CreateCustomizeAlert("POST", "/api/apm/customize/alert", srv.CreateCustomizeAlert)
	add_UpdateCustomizeAlert("PUT", "/api/apm/customize/alert/{id}", srv.UpdateCustomizeAlert)
	add_UpdateCustomizeAlertEnable("PUT", "/api/apm/customize/alert/{id}/switch", srv.UpdateCustomizeAlertEnable)
	add_DeleteCustomizeAlert("DELETE", "/api/apm/customize/alert/{id}", srv.DeleteCustomizeAlert)
	add_GetAlertRecordAttrs("GET", "/api/apm/alert-record-attrs", srv.GetAlertRecordAttrs)
	add_GetAlertRecords("GET", "/api/apm/alert-records", srv.GetAlertRecords)
	add_GetAlertRecord("GET", "/api/apm/alert-records/{groupId}", srv.GetAlertRecord)
	add_GetAlertHistories("GET", "/api/apm/alert-records/{groupId}/histories", srv.GetAlertHistories)
	add_CreateAlertRecordIssue("POST", "/api/apm/alert-records/{groupId}/issues", srv.CreateAlertRecordIssue)
	add_UpdateAlertRecordIssue("PUT", "/api/apm/alert-records/{groupId}/issues", srv.UpdateAlertRecordIssue)
	add_DashboardPreview("POST", "/api/apm/alert-records/customize/alerts/dash-preview/query", srv.DashboardPreview)
}
